...
//                 'Content-Type': 'application/json',
//               },
//               body: JSON.stringify({ settings: { notifications: updatedNotifications } }),
//             });
...
//         'Content-Type': 'application/json',
//       },
//       body: JSON.stringify({ settings: { language: e.target.value } }),
//     });
...
//         'Content-Type': 'application/json',
//       },
//       body: JSON.stringify({ settings: { sessionTimeout: Number(e.target.value) } }),
//     });
...
//         'Content-Type': 'application/json',
//       },
//       body: JSON.stringify({ activityAlertsEnabled: !activityAlertsEnabled }),
//     });

//     if (!response.ok) {
//       throw new Error('Failed to update activity alerts');
//     }
