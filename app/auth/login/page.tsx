    ...
    <div className="min-h-screen w-full flex">
      ...
      <div className="hidden lg:block lg:w-2/3 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          ...
          >
            <h1 className="text-5xl font-bold mb-6">Welcome to Fleet Manager</h1>
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Manage your fleet operations efficiently with our comprehensive platform.
              Track vehicles, handle documents, and ensure compliance all in one place.
            </p>
          </motion.div>
        </div>
      </div>
          ...
          >
            <div className="p-6">
              ...
              <div className="prose prose-sm max-w-none">
                ...
                <h3>3. Disclaimer</h3>
                <p>The materials on Fleet Manager's service are provided on an 'as is' basis. Fleet Manager makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties.</p>
                
                <h3>4. Limitations</h3>
                <p>In no event shall Fleet Manager or its suppliers be liable for any damages arising out of the use or inability to use the materials on Fleet Manager's service.</p>
